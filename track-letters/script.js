...
//let nameArrayx =[XY coordinates or innerwindow/divided by a number];
//let nameArrayy = [];
...
function onDocumentReady() {
  ...
  for(let i = 0; i < nameArray.length; i++) {
    ...
    //names.push(new name (nameArrayx[i], nameArrayy [y], Math.random() * window.innerHeight, nameArray[i]));
  }

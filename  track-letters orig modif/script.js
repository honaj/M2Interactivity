...
function onPointerMove(e) {
  ...
  letters.forEach(letter => {
    ...
    letter.style.fontVariationSettings =
      ...
      //'\'shrp\' ' + parseInt(1000 * (1 - relativeDistance));
      //'\'term\' ' + parseInt(100 * (1 - relativeDistance));
     // '\'dots\' ' + parseInt(1000 * (1 - relativeDistance));

//changed the opacity 
    letter.style.transform =
      'translateZ(' + 100 * (1.0 - relativeDistance / 4) + 'px)';
